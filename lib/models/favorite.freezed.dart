...
/// @nodoc
mixin _$Favorite {
  int get pokeId => throw _privateConstructorUsedError;
...
class _$FavoriteCopyWithImpl<$Res> implements $FavoriteCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? pokeId = freezed,
  }) {
    return _then(_value.copyWith(
      pokeId: pokeId == freezed
          ? _value.pokeId
          : pokeId // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
class _$_Favorite implements _Favorite {
  const _$_Favorite({required this.pokeId});
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.pokeId, pokeId));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(pokeId));
...
abstract class _Favorite implements Favorite {
  const factory _Favorite({required final int pokeId}) = _$_Favorite;
